...
class RecuperarCodigoScreen extends StatelessWidget {
  const RecuperarCodigoScreen({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            TextField(decoration: InputDecoration(hintText: 'Código de 6 dígitos')),
            SizedBox(height: 20),
            ElevatedButton(
              style: ElevatedButton.styleFrom(backgroundColor: Colors.black),
              onPressed: () => Navigator.pushNamed(context, '/recuperar_nova'),
